...
A perceptron built completely from scratch with NumPy - no scikit-learn, no TensorFlow, and trained on logic gates using the actual perceptron learning rule (not gradient descent, that's Practical 2).
